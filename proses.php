<?php 
	...
	$bobot_speck_laptop = array("speed"=>array(5.0,6.0,7.0,7.0,6.8),
	...
	$harga = $_POST['harga'];
	$speedB = $_POST['speed_processorB'];
	$vgaB = $_POST['vgaB'];
	$layarB = $_POST['layarB'];
	$ramB = $_POST['ramB'];
	$hdB = $_POST['jenis_hardiskB'];
	$hargaB = $_POST['hargaB'];
...
<!-- 
                ...
                <div class="progress-table-wrap">
                    <div class="progress-table">
                        <div class="table-head">
                            ...
                            <div class="serial">Speed<br/>Processor</div>
                            <div class="serial">VGA</div>
                            <div class="serial">Layar</div>
                            <div class="serial">RAM</div>
                            <div class="serial">Jenis HD</div>
                            <div class="serial">Harga</div>
                        </div>
                        <div class="table-row">
                            <div class="serial">1</div>
                            <div class="percentage"><?=$speck_laptop[0][0] ?></div>
                            <div class="serial"><?=$x["speed"][0] ?></div>
                            <div class="serial"><?=$x["vga"][0] ?></div>
                            <div class="serial"><?=$x["layar"][0] ?></div>
                            <div class="serial"><?=$x["ram"][0] ?></div>
                            <div class="serial"><?=$x["hd"][0] ?></div>
                            <div class="serial"><?=$x["harga"][0] ?></div>
                        </div>
                        <div class="table-row">
                            <div class="serial">2</div>
                            <div class="percentage"><?=$speck_laptop[1][0] ?></div>
                            <div class="serial"><?=$x["speed"][1] ?></div>
                            <div class="serial"><?=$x["vga"][1] ?></div>
                            <div class="serial"><?=$x["layar"][1] ?></div>
                            <div class="serial"><?=$x["ram"][1] ?></div>
                            <div class="serial"><?=$x["hd"][1] ?></div>
                            <div class="serial"><?=$x["harga"][1] ?></div>
                        </div>
                        <div class="table-row">
                            <div class="serial">3</div>
                            <div class="percentage"><?=$speck_laptop[2][0] ?></div>
                            <div class="serial"><?=$x["speed"][2] ?></div>
                            <div class="serial"><?=$x["vga"][2] ?></div>
                            <div class="serial"><?=$x["layar"][2] ?></div>
                            <div class="serial"><?=$x["ram"][2] ?></div>
                            <div class="serial"><?=$x["hd"][2] ?></div>
                            <div class="serial"><?=$x["harga"][2] ?></div>
                        </div>
                        <div class="table-row">
                            <div class="serial">4</div>
                            <div class="percentage"><?=$speck_laptop[3][0] ?></div>
                            <div class="serial"><?=$x["speed"][3] ?></div>
                            <div class="serial"><?=$x["vga"][3] ?></div>
                            <div class="serial"><?=$x["layar"][3] ?></div>
                            <div class="serial"><?=$x["ram"][3] ?></div>
                            <div class="serial"><?=$x["hd"][3] ?></div>
                            <div class="serial"><?=$x["harga"][3],2 ?></div>
                        </div>
            ...
            <div class="section-top-border">
                ...
                <br/>
                <a href="index.php" class="genric-btn primary-border circle arrow">
